...
// #region ContactPhoneNumberFunction
...
contactName.onblur = function(e){
  ...
  if(personName == ""){
    document.getElementById("nameAlert").innerHTML = "فیلد خالیست لطفا آن را پر کنید";
...
// #region EditButton
//دراینجا فانکشنی درست کرده ام مبنی بر اینکه اگر شروط در فانکشن های بالا درست بود و فیلد ها درست پر شده اند هنگام کلیک بر روی دکمه ویرایش پیغامی برای آن ها نشان داده شود
